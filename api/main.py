...
_BLUE = "\033[94m" if _COLOR_ENABLED else ""
_CYAN = "\033[1;96m" if _COLOR_ENABLED else ""
_MAGENTA = "\033[95m" if _COLOR_ENABLED else ""
...
⠀⠀⠀⠀⠀⠘⠢⠦⠤⠐⠂⠉⠀⠀⠀⠀⠈⠑⠒⠒⠒⠋⠁⠀{_RESET}
          ...
          {_CYAN}PkkMind v2.0{_RESET} {_MAGENTA}· Experiment 626{_RESET}
               智能客服 AI 系统
"""
...
async def lifespan(app: FastAPI):
    ...
    skills_dir = os.getenv("PKKMIND_SKILLS_DIR", str(pathlib.Path(_ROOT) / "skills"))
...
async def _cli():
    ...
    while True:
        ...
        print(f"\nPkkMind [{result.agent_type.value}]: {result.response}\n")
